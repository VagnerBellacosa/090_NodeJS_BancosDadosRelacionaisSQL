...
- [Próxima](https://developer.mozilla.org/pt-BR/docs/Learn/Server-side/Express_Nodejs/development_environment)
...
| Pré-requisitos: | Conhecimentos básicos em informática. Uma compreensão geral de [programação web no lado servidor (backend)](https://developer.mozilla.org/pt-BR/docs/Learn/Server-side/First_steps), em particular, nos mecanismos de [interação cliente-servidor de websites](https://developer.mozilla.org/pt-BR/docs/Learn/Server-side/First_steps/Client-Server_overview). |
| :-------------- | ------------------------------------------------------------ |
...
## [O que é Express e Node ?](https://developer.mozilla.org/pt-BR/docs/Learn/Server-side/Express_Nodejs/Introduction#o_que_é_express_e_node)

[Node](https://nodejs.org/) (ou formalmente *Node.js*) é um ambiente em tempo de execução open-source (código aberto) e multiplataforma que permite aos desenvolvedores criarem todo tipo de aplicativos e ferramentas do lado servidor (backend) em [JavaScript](https://developer.mozilla.org/pt-BR/docs/Glossary/JavaScript). Node é usado fora do contexto de um navegador (ou seja executado diretamente no computador ou no servidor). Como tal, o ambiente omite APIs JavaScript específicas do navegador e adiciona suporte para APIs de sistema operacional mais tradicionais, incluindo bibliotecas de sistemas HTTP e arquivos.
...
### [Olá, Node.js](https://developer.mozilla.org/pt-BR/docs/Learn/Server-side/Express_Nodejs/Introduction#olá_node.js)
...
## [Web Frameworks](https://developer.mozilla.org/pt-BR/docs/Learn/Server-side/Express_Nodejs/Introduction#web_frameworks)
...
## [Introduzindo o Express](https://developer.mozilla.org/pt-BR/docs/Learn/Server-side/Express_Nodejs/Introduction#introduzindo_o_express)
...
## [De onde o Node e o Express vieram?](https://developer.mozilla.org/pt-BR/docs/Learn/Server-side/Express_Nodejs/Introduction#de_onde_o_node_e_o_express_vieram)
...
## [O quão popular é Node/Express ?](https://developer.mozilla.org/pt-BR/docs/Learn/Server-side/Express_Nodejs/Introduction#o_quão_popular_é_nodeexpress)
...
## [Express é opinativo ?](https://developer.mozilla.org/pt-BR/docs/Learn/Server-side/Express_Nodejs/Introduction#express_é_opinativo)
...
## [Como se parece o código do Express ?](https://developer.mozilla.org/pt-BR/docs/Learn/Server-side/Express_Nodejs/Introduction#como_se_parece_o_código_do_express)
...
### [Olá Mundo Express](https://developer.mozilla.org/pt-BR/docs/Learn/Server-side/Express_Nodejs/Introduction#olá_mundo_express)
...
**Dica:** Se você tiver o Node e o Express já instalados (ou se você os instalar como mostrado no [próximo artigo](https://developer.mozilla.org/pt-BR/docs/Learn/Server-side/Express_Nodejs/development_environment), você pode salvar este código em um arquivo chamado **app.js** e executá-lo em um prompt, ao digitar o comando `node app.js`.
...
### [Importando e criando módulos](https://developer.mozilla.org/pt-BR/docs/Learn/Server-side/Express_Nodejs/Introduction#importando_e_criando_módulos)
...
### [Usando APIs assíncronas](https://developer.mozilla.org/pt-BR/docs/Learn/Server-side/Express_Nodejs/Introduction#usando_apis_assíncronas)
...
### [Criando manipuladores de rotas](https://developer.mozilla.org/pt-BR/docs/Learn/Server-side/Express_Nodejs/Introduction#criando_manipuladores_de_rotas)
...
Vamos mostrar-lhe muito mais sobre trabalhar com rotas e, em particular, sobre o uso do `Router`, mais tarde, na seção vinculada [Rotas e controladores](https://developer.mozilla.org/pt-BR/docs/Learn/Server-side/Express_Nodejs/routes).

### [Usando middleware](https://developer.mozilla.org/pt-BR/docs/Learn/Server-side/Express_Nodejs/Introduction#usando_middleware)
...
### [Servindo arquivos estáticos](https://developer.mozilla.org/pt-BR/docs/Learn/Server-side/Express_Nodejs/Introduction#servindo_arquivos_estáticos)
...
Para obter mais informações, consulte [Servindo arquivos estáticos no Express](https://developer.mozilla.org/pt-BR/docs/Learn/Server-side/Express_Nodejs/Serving static files in Express).

### [Erros de manipulação](https://developer.mozilla.org/pt-BR/docs/Learn/Server-side/Express_Nodejs/Introduction#erros_de_manipulação)
...
### [Usando Banco de Dados](https://developer.mozilla.org/pt-BR/docs/Learn/Server-side/Express_Nodejs/Introduction#usando_banco_de_dados)
...
### [Renderizando dados (views)](https://developer.mozilla.org/pt-BR/docs/Learn/Server-side/Express_Nodejs/Introduction#renderizando_dados_views)
...
## [Sumário](https://developer.mozilla.org/pt-BR/docs/Learn/Server-side/Express_Nodejs/Introduction#sumário)
...
## [Veja também](https://developer.mozilla.org/pt-BR/docs/Learn/Server-side/Express_Nodejs/Introduction#veja_também)
...
- [Serving static files in Express](https://developer.mozilla.org/pt-BR/docs/Learn/Server-side/Express_Nodejs/Serving static files in Express) (Express docs)
